...
class Agent:
    def __init__(self, location, heading=0, radius=8.0, range_finder_range=100.0,
            max_speed=10.0, max_angular_vel=3.0, speed_scale=1.0, angular_scale=1.0):
    ...
    def update_radars(self, exit_point):
        ...
        # ゴールとロボットの角度をアークタンジェントで求めてpiで割る
...
class MazeEnvironment:
    ...
    def read_environment(ROOT_DIR, maze_name, maze_kwargs={}, agent_kwargs={}):
        ...
        """
        maze_file = os.path.join(ROOT_DIR, 'envs', 'flappy', 'stage_files', f'{maze_name}.txt')
